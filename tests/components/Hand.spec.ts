...
describe("visible hand", () => {
	test("renders hand with no aces", () => {
	...
	test("renders hand with one ace", () => {
		const newHand = createHand(false);
	...
	test("renders hand with multiple aces", () => {
		const newHand = createHand(false);
...
describe("hidden hand", () => {
	...
	test("renders hand with hidden ace", () => {
		const newHand = createHand(true);
		const updatedHand = addCardsToHand(newHand, [cardAce, card3]);
		const result = render(Hand, updatedHand);
		expect(() => result.getByText("3")).not.toThrow();
	...
	test("renders hand with one ace visible", () => {
		const newHand = createHand(true);
	...
	test("renders hand with multiple aces visible", () => {
		const newHand = createHand(true);
	...
	test("renders hand with all aces", () => {
		const newHand = createHand(true);
